...
export const MUSIC_CFG = {
  ...
  menuVol:     0.33,  // громкость меню-трека (приглушённо) — тише на ~5%
  introVol:    0.665, // громкость вступительного трека (0..1) — тише на ~5%
  combatVol:   0.665, // громкость боевого трека (0..1) — тише на ~5%
  ambientVol:  0.18,  // громкость фонового ветра (0..1) — сделан заметно тише
